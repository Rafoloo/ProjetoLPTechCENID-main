...
const BasicButtons = ({ id, nome, cpf, rg, cartao_sus, data_nascimento, telefone, sexo, endereco, numero, 
  ...
  const handleOpen = async () => {
    ...
    await auth.atualizar(id, nome, cpf, rg, cartao_sus, DataNascimento, telefone, sexo, endereco, numero, 
      nome_responsavel, cpf_responsavel, rg_responsavel, parentesco_responsavel, telefone_responsavel, ocupacao_responsavel,
